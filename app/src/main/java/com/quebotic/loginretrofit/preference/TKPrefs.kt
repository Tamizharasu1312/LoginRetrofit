package com.quebotic.loginretrofit.preference
...
object TKPrefs {
    ...
    val preferences: SharedPreferences
        get() {
            ...
            throw RuntimeException("Prefs class not correctly instantiated please call Builder.setContext().build(); in the AppController class onCreate.")
        }
